...
## CSS
/* RESPONSIVE DESIGN by Sidebars
*  No Sidebar              - Small Screen  0-849px
*  Left Sidebar (Nav Menu) - Medium Screen 850-1199px
*  Both Sidebar (ToC Menu) - Large Screen  1200+px
* 
* RESPONSIVE DESIGN by Device
*  Mobile devices - Small Screen  0-320px
*  Tablets        - Medium Screen 321-768px
*  Desktops       - Large Screen  768-1024px
*
* WIDTH-NUMBER
*  W-49: Place two items next to eachother (width 49%)
*  W-33: Place three items next to eachother (width 33%)
*
* Breakline
*  S:  Break on Small Screen
*  SM: Break on Small and Medium Screen
*  ML: Break on Medium and Large Screen
*  L:  Break on Large Screen
*/
...
----------------------------------------
## ICONS
fas fa-person-hiking 			(signature, about, avatar, flavicon,)
fas fa-mountain-sun				(signature)
### style
fa-3x 							(hiking and mountain, maintenance)
fa-2x 							(quotation-mark)
fa-fw 							(lists, contact; fixed width)
fa-li 							(list bullets)
### lists
far fa-circle 					(unchecked item)
far fa-circle-check 			(checked item)
far fa-circle-dot 				(semi checked item)
far fa-circle-dot 				(not checked item)
### sources
fas fa-up-right-from-square 	(external link)
fab fa-google
fab fa-wikipedia-w
fab fa-flickr
### contact
...
fas fa-rss
### tabs
fas fa-house home 					(/home)
fas fa-person-hiking 				(/about)
fas fa-stream 						(/category)
fas fa-image 						(/photos)
fas fa-tags							(/tags)
fas fa-timeline						(/timeline)
### /about/
fas fa-circle-user 					(about: me)
fas fa-circle-info 					(about: page)
fas fa-route 						(about: route)
fas fa-person-walking-arrow-right 	(about: training)
fas fa-campground 					(about: gear)
fas fa-thumbs-up 					(about: thanks)
### /category/
fas fa-leaf 						(category: 2025 trial run)
fas fa-mountain-sun 				(category: 2026 my pilgrimage)
fas fa-head-side-virus 				(category: rambling)
fas fa-person-digging 				(category: site)
### posts
fas fa-thumbtack					(pinned)
far fa-folder-open 					(head category)
far fa-folder						(sub category)
fa fa-tag 							(tag, img post)
far fa-calendar 					(countdown, img date)
fas fa-location-dot					(img location)
fas fa-camera 						(img author)
fas fa-quote-left 					(quotes)
fas fa-person-digging				(maintenance prompt)
### share
...
<!-- ![Way of St. James pilgrims (1568)](https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Jakobsweg_-_Pilger_1568_-_Hurden_IMG_5664.JPG/454px-Jakobsweg_-_Pilger_1568_-_Hurden_IMG_5664.JPG) -->
...
<!-- ![Approximate map of the Route](https://upload.wikimedia.org/wikipedia/commons/2/2b/Ways_of_St._James_in_Europe.png) -->
...
<!-- ![Samos, in Galicia, on the French Way or Camino Francés](https://upload.wikimedia.org/wikipedia/commons/8/83/Samos_on_the_Camino_Way.jpg){: .w-50 } -->
...
<!-- ![Roman bridge over the river Órbigo](https://upload.wikimedia.org/wikipedia/commons/2/28/Hospital_de_%C3%93rbigo_%28496110133%29.jpg) -->
...
<!-- ![Man wearing pilgrim clothing. 450 - 425 BC. Prague, NM-HM10 771](https://upload.wikimedia.org/wikipedia/commons/5/50/Man_wearing_pilgrim_clothing%2C_450-425_BC%2C_Prague_NM-HM10_771%2C_151792.jpg){: .w-50 } -->
