...
<figure class="img-gallery">
  ...
  <figcaption class="gallery-caption">
	<cite>**A Sunny Sundays Sun**</cite> <br/>
...
<figure class="img-gallery">
  ...
  <figcaption class="gallery-caption">
	<cite>**Waterlogged Bench**</cite> <br/>
...
<figure class="img-gallery">
  ...
  <figcaption class="gallery-caption">
	<cite>**Small Trunk-bridge**</cite> <br/>
...
<figure class="img-gallery">
  ...
  <figcaption class="gallery-caption">
	<cite>**Camping Tent**</cite> <br/>
	The current <i>(way to heavy)</i> tent I use on vacation.
	<br class="resp-linebreak-m"/>
	<i class="far fa-calendar"></i> 04-06-2024, 
	<i class="fa-solid fa-location-dot"></i> Somewhere near Weert Brabant. 
	<!-- <br class="resp-linebreak-m"/> -->
	<!-- <i class="fa-solid fa-camera"></i> Taken by PICTURE_TAKEN_BY. -->
	<!-- <i class="fa-solid fa-tag"></i> [PICTURE_POST_ORIGIN](POST_URL). -->
  </figcaption>
...
<figure class="img-gallery">
  ...
  <figcaption class="gallery-caption">
	<cite>**A small Campfire**</cite> <br/>
	A caption campfire while on vacation with friends.  
	<br class="resp-linebreak-m"/> 
	<i class="far fa-calendar"></i> 29-05-2023, 
	<i class="fa-solid fa-location-dot"></i> Somewhere near the Utrechtse Heuvelrug. 
	<br class="resp-linebreak-m"/> 
...
<figure class="img-gallery">
  ...
  <figcaption class="gallery-caption">
	<cite>**Autumn Wilderness**</cite> <br/>
...
<figure class="img-gallery">
  ...
  <figcaption class="gallery-caption">
	<cite>**The Dutch Lowlands**</cite> <br/>
	On vacation in the Netherlands. 
	<br class="resp-linebreak-m"/> 
	<i class="far fa-calendar"></i> 06-08-2021 
	<i class="fa-solid fa-location-dot"></i> Somewhere in Brabant. 
	<br class="resp-linebreak-m"/> 
