...
## Results
**Avg. Hours of Walking:**  hr /  hr per day =  days <br/>
**Avg. Distance to Walk:**  km /  km per day =  days <br/>
**Avg. Walking Speed:**  km /  hr =  km/h <br/>
**Conclusion:** <br/>
  day, 
walking  km/h for  hrs, 


#### Quick Pilgrimage Route Calculation

- **<sup>Avg.</sup> Hours of Walking:** ROUTE_TOTAL_HOURS <sup>hr</sup> / AVG_WALKING_HOURS <sup>hr</sup> per day = **AVG_DAYS_WALKING days**
- **<sup>Avg.</sup> Distance to Walk:** ROUTE_TOTAL_DISTANCE <sup>km</sup> / AVG_WALKING_DISTANCE <sup>km</sup> per day = **AVG_DAYS_WALKING days** (EXACT_DAYS_WALKING)
- **<sup>Avg.</sup> Walking Speed:** ROUTE_TOTAL_DISTANCE <sup>km</sup> / ROUTE_TOTAL_HOURS <sup>hr</sup> = **AVG_WALKING_SPEED <sup>km</sup>/<sub>h</sub>**
- **Conclusion:** <br/>
  So I will walk for atleast AVG_DAYS_WALKING days, walking AVG_WALKING_SPEED <sup>km</sup>/<sub>h</sub>, 
  for AVG_WALKING_HOURS <!--AVG_WALKING_HOURS<sup>AVG_WALKING_HOURS_KWART</sup>/<sub>4</sub>-->hrs,</sup> 
