...
categories: [2025 Trial-Run, Preparations] <!--[2025 Trial-Run, On The Way]-->
...
## IMAGE
![ALT_NAME](https://github.com/MyPilgrimage/MyPilgrimage.github.io/assets/PIC_LOCATION.png){: }
...
<!--IMAGE_OPTIONALS-->
<!-- ![ALT_NAME](https://github.com/MyPilgrimage/MyPilgrimage.github.io/assets/PIC_LOCATION.png) {: w='1280' h='720' .light/dark .w-100/75/50/25 .normal/left/right .shadow .rounded-10/20/bottom10 } -->
...
> <figure><img src="https://github.com/MyPilgrimage/MyPilgrimage.github.io/assets/IMG_LOCATION.png" alt="ALT_NAME">{: height="150px" .normal }<figcaption>See updates on my current location &nbsp; <i class="fa-solid fa-location-dot"></i> UPDATED_LOCATION &nbsp; <i class="far fa-calendar"></i> UPDATED_DD_MM_YYYY</figcaption>{: .caption }</figure> 
{: .prompt-warning}

<div class="responsiveGallery">
<figure class="imgGallery">
  <img src="https://github.com/MyPilgrimage/MyPilgrimage.github.io/assets/IMG_LOCATION.png" alt="ALT_NAME" width="600" height="400" class="galleryImg">
