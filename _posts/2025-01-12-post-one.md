...
> <sub> ~QUOTE_AUTHOR, <cite>QUOTE_ORIGIN</cite></sub>{: .sub-citation } <br/>
...
> <sub> Bilbo Baggins Poem in honor of Aragorn.</sub>{: .sub-citation } <br/>
...
> <sub> Gandalf speaking to Bilbo who called the skin-changer Beorn a Furrier.</sub>{: .sub-citation } <br/>
