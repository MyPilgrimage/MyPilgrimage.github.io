...
## IMAGE
![ALT_NAME](/assets/PIC_LOCATION.PNG){: }
...
<!--IMAGE_OPTIONALS-->
<!-- ![ALT_NAME](/assets/PIC_LOCATION.PNG) {: w='1280' h='720' .light/dark .w-100/75/50/25 .normal/left/right .shadow .rounded-10/20/bottom10 } -->
...
> <figure><img src="/assets/IMG_LOCATION.PNG" alt="ALT_NAME">{: height="150px" .normal }<figcaption>See updates on my current location &nbsp; <i class="fa-solid fa-location-dot"></i> UPDATED_LOCATION &nbsp; <i class="far fa-calendar"></i> UPDATED_DD_MM_YYYY</figcaption>{: .caption }</figure> 
{: .prompt-warning}

<div class="responsiveGallery">
<figure class="imgGallery">
  <img src="/assets/IMG_LOCATION.PNG" alt="ALT_NAME" width="600" height="400" class="galleryImg">
