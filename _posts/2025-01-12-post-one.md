...
<!--LINK_TO_WIKIPEDIA-->
[WIKI_PAGE_TITLE <i class="fa-brands fa-wikipedia-w"></i><i class="fa-solid fa-up-right-from-square"></i>](<!--WIKI_PAGE-->)
<!--LINK_TO_FLICKR-->
[FLICKR_PAGE_TITLE <i class="fa-brands fa-flickr"></i><i class="fa-solid fa-up-right-from-square"></i>](<!--FLICKR_PAGE-->)
<!--LINK_TO_GOOGLE-->
[GOOGLE_PAGE_TITLE <i class="fa-brands fa-google"></i><i class="fa-solid fa-up-right-from-square"></i>](<!--GOOGLE_PAGE-->)
